...
## summary.md (Max 8 marks)
  ...
  - Scenarios have been described clearly (max 2 marks)    
    ...
    Comment: Direct show in each scenarios, how would the user interact with the application instead of using the as ..., [doing work] phrase. 
  ...
  - Principles have been described clearly (max 2 marks)
    ...
    Comment: Need more detail for it.
