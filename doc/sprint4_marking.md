...
**Team Name:** Seal  
**Github:** https://github.com/UTSCCSCC01/project-seal
...
## Daily Stand-ups (max 10 marks)
  ...
  Feedback: Standup 1 - 2 group members did not post their standup within the 24 hour timeframe (-2)
            Standup 2 - All group members participated
            Standup 3 - 3 group members did not post their standup within the 24 hour timeframe (-2)
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0
    Feedback: no success criteria provided on Jira user stories 
