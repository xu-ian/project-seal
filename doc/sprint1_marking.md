...
There is some documentation for frontend/backend systems (LoginResgistration.md, SEAL-4). 

As someone with an outside perspective, it was nice to get a quick overview but the information is a bit lacking for if I were to dive in and start contributing.
